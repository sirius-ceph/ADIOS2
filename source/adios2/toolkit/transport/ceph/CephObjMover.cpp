/*
 * CephObjMover.cpp moves Ceph objects to/from storage tiers.
 *
 *  Created on: 
 *      Author:  Ken IIzawa
 */
    ...
    case SLOW:
        {
            ...
            if (current_tier == ARCHIVE) {  // remove the redirect in Storage Pool
                librados::ObjectWriteOperation op;
                op.remove();
                librados::AioCompletion *completion = cluster_->aio_create_completion();
                ...
                // promote the object to Storage Pool
